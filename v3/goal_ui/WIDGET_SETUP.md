# GOAP Widget - Embeddable Research Interface
...
<head>
  ...
  <title>My Site with GOAP Widget</title>
</head>
<body>
  <!-- Widget Container -->
...
The widget exposes a global `GOAPWidget` object:
...
- Customize via `GOAPWidgetConfig`
...
- Review console logs with `[GOAP Widget]` prefix
