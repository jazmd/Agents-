# GOAL Widget - Embeddable Research Interface
...
<head>
  ...
  <title>My Site with GOAL Widget</title>
</head>
<body>
  <!-- Widget Container -->
...
The widget exposes a global `GoalWidget` object:
...
- Customize via `GoalWidgetConfig`
...
- Review console logs with `[GOAL]` prefix
