<script lang="ts">
	...
	const examplePrompts = [
		...
		'"Analyze the diff at github.com/0x-wzw/ruflo/pull/1687 — risk score, classify, and suggest reviewers."',
	];
	...
	const domains: { url: string; note: string }[] = [
		{ url: "flo.teoh.my", note: "Primary — shortest URL, recommended" },
		{ url: "ruflo.teoh.my", note: "Brand alias" },
		{ url: "flo.teoh.my", note: "Original alias (matches the upstream chat-ui fork name)" },
		...
		<div class="flex-1 overflow-y-auto px-6 py-4">
			...
			<section class="mb-6">
				...
				<div class="mt-3 rounded-lg border border-emerald-300/40 bg-emerald-50/50 px-3 py-2 text-xs dark:border-emerald-700/40 dark:bg-emerald-900/10">
					...
					<p class="mt-1 text-emerald-900/80 dark:text-emerald-200/80">Ruflo speaks any OpenAI-compatible endpoint: vLLM, Ollama, LM Studio, Together, Groq, or self-hosted. Native support for <a href="https://github.com/0x-wzw/k2-backbone" target="_blank" rel="noopener" class="underline">ruvLLM</a> (lives in <code>0x-wzw/k2-backbone</code>) — Ruflo's self-improving local model layer with MicroLoRA adapters that learn from your trajectories via SONA. Pair cloud + local, or run fully offline.</p>
				</div>
			</section>
			...
			<section>
				...
				<ul class="space-y-1 text-sm">
					<li>
						<a href="https://github.com/0x-wzw/ruflo" target="_blank" rel="noopener" class="text-blue-600 hover:underline dark:text-blue-400">
							github.com/0x-wzw/ruflo →
						</a>
					</li>
					<li>
						<a href="https://github.com/0x-wzw/ruflo/blob/main/ruflo/docs/adr/ADR-033-RUVOCAL-WASM-MCP-INTEGRATION.md" target="_blank" rel="noopener" class="text-blue-600 hover:underline dark:text-blue-400">
							ADR-033 — Web UI architecture →
						</a>
					</li>
					<li>
						<a href="https://github.com/0x-wzw/ruflo/issues/1689" target="_blank" rel="noopener" class="text-blue-600 hover:underline dark:text-blue-400">
							Issue #1689 — UI capabilities & roadmap →
						</a>
					</li>
					<li>
						<a href="https://github.com/0x-wzw/ruvector" target="_blank" rel="noopener" class="text-blue-600 hover:underline dark:text-blue-400">
							0x-wzw/k2-backbone — intelligence layer →
						</a>
					</li>
				</ul>
			</section>
