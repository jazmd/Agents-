const en = {
  ...
  tutor: {
    eyebrow: 'AI tutor',
    title: 'Ask anything, get a careful answer.',
    body: 'The Tickra tutor explains, clarifies, and pushes back. It does not give signals, recommendations, or guarantees — by design. It is grounded in our 57 lessons and refuses anything outside.',
    placeholder: 'Ask about candles, risk, structure, strategy…',
    send: 'Ask',
    thinking: 'Thinking…',
    ...
    disclaimer: 'Educational only. The tutor never gives entries, exits, or guarantees.',
    fallback: 'AI tutor is in demo mode — answers are rule-based until an LLM key is configured.',
    suggestions: [
      'Explain a bullish engulfing in plain language.',
      'How do I size a position with a 2% risk and a 30-pip stop?',
      'When is RSI dangerous to use?',
  ...
  portfolio: {
    ...
    body: 'Trade six instruments against a deterministic mock price. Every open and close persists. Use it to journal real reasoning without real risk.',
    starting: 'Starting',
    balance: 'Balance',
    ...
    close: 'Close',
    noOpen: 'No open positions. Open one above.',
    noClosed: 'No closed trades yet.',
    columns: { symbol: 'Symbol', side: 'Side', qty: 'Qty', entry: 'Entry', mark: 'Mark', pnl: 'P&L', opened: 'Opened' },
    closedColumns: { exit: 'Exit', closed: 'Closed' },
    demoBanner: 'Demo mode: positions are stored in a cookie on this device.',
  },
  community: {
    eyebrow: 'Community',
    title: 'Where Tickra learners think out loud.',
    body: 'Six categories, one rule: be specific. No promotion, no signals, no get-rich-quick. Tickra moderates lightly; the community moderates the rest.',
    ...
    new: {
      ...
      body: 'A clear question or observation. Aim for one idea per thread.',
      category: 'Category',
      threadTitle: 'Title',
      threadBody: 'Body',
      submit: 'Publish',
      cancel: 'Cancel',
      placeholderTitle: 'What did you actually do on this trade?',
      placeholderBody: 'Setup, thesis, outcome. The more specific the better.',
      rateLimit: 'You have reached today’s posting limit. Try again tomorrow.',
      invalid: 'Title must be 4–140 chars and body 8–4000.',
    },
    reply: {
      label: 'Your reply',
      submit: 'Post reply',
      empty: 'No replies yet. Be the first.',
      placeholder: 'Add to the discussion. Be specific.',
    },
    emptyCategory: 'Nothing here yet. Start the first thread.',
    demoNotice: 'Demo mode: read-only. Sign in to post.',
  },
  glossary: {
    eyebrow: 'Glossary',
  ...
  compare: {
    ...
    rows: [
      ...
      { feature: 'Community forum', values: ['yes', 'yes', 'no', 'yes', 'no', 'no'] },
      { feature: 'Paper trading portfolio', values: ['yes', 'no', 'partial', 'partial', 'yes', 'no'] },
      { feature: 'Completion certificates (PDF)', values: ['yes', 'no', 'partial', 'no', 'partial', 'yes'] },
      { feature: 'AI tutor (curriculum-grounded)', values: ['yes', 'no', 'no', 'no', 'no', 'no'] },
