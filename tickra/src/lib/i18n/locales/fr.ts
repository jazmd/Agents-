const fr = {
  ...
  reviews: {
    ...
    body: 'Tickra espace les répétitions selon la science de la mémoire. Notez honnêtement chaque leçon ; l’algorithme s’occupe du reste.',
    empty: 'Rien à réviser aujourd’hui. Revenez demain.',
    grade: {
      again: 'Encore',
      hard: 'Difficile',
      good: 'Bien',
    ...
    cta: 'Ouvrir la leçon',
    interval: 'Prochaine révision',
  },
  journal: {
    eyebrow: 'Journal de décisions',
    title: 'Écrivez le trade avant qu’il n’arrive.',
    body: 'Chaque entrée est l’enregistrement de ce que vous pensiez avant de connaître l’issue. Relisez‑les chaque semaine — c’est là que vivent les leçons.',
    new: 'Nouvelle entrée',
    fields: {
      symbol: 'Symbole',
      symbolPlaceholder: 'EUR/USD',
      setup: 'Setup',
      setupPlaceholder: 'Avalement haussier sur support 1H',
      thesis: 'Thèse',
      thesisPlaceholder: 'Une phrase : pourquoi ce trade devrait fonctionner ?',
      invalidation: 'Invalidation',
      invalidationPlaceholder: 'Prix sous 1,0820',
      target: 'Cible',
      targetPlaceholder: '1,0950 — résistance précédente',
      emotion: 'Émotion avant l’entrée',
      submit: 'Enregistrer',
      cancel: 'Annuler',
    },
    emotions: {
    ...
    empty: 'Aucune entrée pour l’instant. La première enseigne le plus.',
  },
  status: {
    eyebrow: 'État',
