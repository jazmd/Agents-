const fr = {
    ...
    plans: [
      {
        ...
        features: [
          ...
          '10 leçons gratuites (1 par piste)',
          '3 vies par jour',
          'Suivi des streaks',
      ...
      },
      {
        ...
        features: [
          ...
          'Toutes les futures leçons incluses à vie',
          'Cohorte privée + revue mensuelle',
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: 'Portefeuille papier', href: '/portfolio' },
          { label: 'Certificats', href: '/certificates' },
          { label: 'Tuteur IA', href: '/tutor' },
  ...
  tutor: {
    eyebrow: 'Tuteur IA',
    title: 'Posez n’importe quoi, recevez une réponse soignée.',
    body: 'Le tuteur Tickra explique, clarifie, et pousse à réfléchir. Il ne donne ni signaux, ni recommandations, ni garanties — par conception. Il s’appuie sur nos 57 leçons et refuse tout ce qui sort du cursus.',
    placeholder: 'Demandez sur les bougies, le risque, la structure, la stratégie…',
    send: 'Demander',
    thinking: 'Réflexion…',
    ...
    disclaimer: 'Éducatif uniquement. Le tuteur ne donne jamais d’entrée, de sortie, ou de garantie.',
    fallback: 'Tuteur IA en mode démo — réponses heuristiques tant qu’une clé LLM n’est pas configurée.',
    suggestions: [
      'Explique un avalement haussier en langue simple.',
      'Comment dimensionner une position avec 2 % de risque et un stop à 30 pips ?',
      'Quand le RSI est-il dangereux à utiliser ?',
  ...
  portfolio: {
    ...
    body: 'Tradez six instruments contre un prix simulé déterministe. Chaque ouverture et clôture persiste. Sert à journaliser un vrai raisonnement sans risque réel.',
    starting: 'Capital initial',
    balance: 'Solde',
    realised: 'P&L réalisé',
    openLabel: 'Ouvrir une position',
    ...
    history: 'Trades clôturés',
    close: 'Clôturer',
    noOpen: 'Aucune position ouverte. Ouvrez-en une ci-dessus.',
    noClosed: 'Aucun trade clôturé pour l’instant.',
    columns: { symbol: 'Symbole', side: 'Sens', qty: 'Qté', entry: 'Entrée', mark: 'Prix', pnl: 'P&L', opened: 'Ouverte' },
    closedColumns: { exit: 'Sortie', closed: 'Clôturée' },
    demoBanner: 'Mode démo : les positions sont stockées dans un cookie sur cet appareil.',
  },
  community: {
    eyebrow: 'Communauté',
    title: 'Où les apprenants Tickra pensent à voix haute.',
    body: 'Six catégories, une règle : soyez précis. Pas de promotion, pas de signaux, pas de promesses d’enrichissement. Tickra modère légèrement ; la communauté modère le reste.',
    newThread: 'Ouvrir un sujet',
    signinToPost: 'Connectez-vous pour poster',
    categories: {
      general: 'Général',
      beginners: 'Débutants',
      patterns: 'Figures',
    ...
    new: {
      ...
      body: 'Une question claire ou une observation. Une idée par sujet.',
      category: 'Catégorie',
      threadTitle: 'Titre',
      threadBody: 'Contenu',
      submit: 'Publier',
      cancel: 'Annuler',
      placeholderTitle: 'Qu’avez-vous fait réellement sur ce trade ?',
      placeholderBody: 'Setup, thèse, issue. Plus c’est précis, mieux c’est.',
      rateLimit: 'Vous avez atteint la limite de publications du jour. Réessayez demain.',
      invalid: 'Titre 4–140 caractères, contenu 8–4000.',
    },
    reply: {
      label: 'Votre réponse',
      submit: 'Publier la réponse',
      empty: 'Aucune réponse pour l’instant. Soyez le premier.',
      placeholder: 'Ajoutez à la discussion. Soyez précis.',
    },
    emptyCategory: 'Rien ici pour l’instant. Lancez le premier sujet.',
    demoNotice: 'Mode démo : lecture seule. Connectez-vous pour poster.',
  },
  glossary: {
    eyebrow: 'Glossaire',
    title: 'Le trading, un mot à la fois.',
    body: 'Le vocabulaire du prix, du risque, de la structure et de l’exécution — défini honnêtement, en langue claire.',
    placeholder: 'Chercher un terme…',
    empty: 'Aucun terme ne correspond. Essayez moins de lettres.',
    categories: {
  ...
  tools: {
    eyebrow: 'Outils',
    title: 'Les calculatrices de poche de tout trader.',
    body: 'Trois calculatrices, à utiliser avant chaque entrée. Aucune connexion requise.',
    position: {
      title: 'Taille de position',
      body: 'Combien d’unités acheter ou vendre pour que le stop coûte exactement votre budget de risque.',
      account: 'Taille du compte',
      accountUnit: '€',
      riskPct: 'Risque par trade',
      entry: 'Prix d’entrée',
      stop: 'Prix du stop',
      result: 'Taille de position',
      unitsLabel: 'unités',
      risked: 'Risque',
    },
    rr: {
      title: 'Risque / récompense',
      body: 'Calcule le taux de réussite à l’équilibre pour un ratio R/R donné. En-dessous, la stratégie saigne.',
      ratio: 'Ratio R/R (1:n)',
      breakeven: 'Taux de réussite à l’équilibre',
    },
    pip: {
      title: 'Valeur d’un pip',
      body: 'Valeur monétaire d’un pip sur une paire forex, selon la taille du lot et la devise de cotation.',
      lot: 'Taille du lot (1.0 = 100 000 unités)',
      pair: 'Paire cotée en',
      result: 'Un pip vaut',
    },
  },
  calendar: {
    ...
    title: 'Quand le marché bouge sur l’actualité.',
    body: 'Le même calendrier que regardent les desks professionnels. Filtrez par impact et pays directement dans le widget.',
  },
  compare: {
    eyebrow: 'Comparatif',
    title: 'Ce que les autres écoles de trading ratent.',
    body: 'Nous avons audité les cinq sites d’éducation au trading les plus visités. Voici la comparaison honnête — fonctionnalités, pas slogans.',
    headers: ['Fonctionnalité', 'Tickra', 'Babypips', 'Investopedia', 'TradingView Edu', 'IG Academy', 'Cours Udemy'],
    legend: { yes: 'Oui', no: 'Non', partial: 'Partiel' },
    rows: [
      ...
      { feature: 'Bilingue EN + FR', values: ['yes', 'no', 'partial', 'yes', 'partial', 'partial'] },
      { feature: 'Niveau adaptatif (test de placement)', values: ['yes', 'no', 'no', 'no', 'no', 'no'] },
      { feature: 'Cursus risque-d’abord', values: ['yes', 'partial', 'no', 'no', 'partial', 'no'] },
      { feature: 'Pas de fausses preuves de performance', values: ['yes', 'yes', 'yes', 'yes', 'yes', 'no'] },
      { feature: 'Forum communauté', values: ['yes', 'yes', 'no', 'yes', 'no', 'no'] },
      { feature: 'Portefeuille paper trading', values: ['yes', 'no', 'partial', 'partial', 'yes', 'no'] },
      { feature: 'Certificats PDF de complétion', values: ['yes', 'no', 'partial', 'no', 'partial', 'yes'] },
      { feature: 'Tuteur IA (basé sur le cursus)', values: ['yes', 'no', 'no', 'no', 'no', 'no'] },
      { feature: 'Option d’achat unique', values: ['yes', 'oui (gratuit)', 'no', 'no', 'oui (gratuit)', 'yes'] },
    ],
    footnote: 'Audit réalisé en mai 2026. Nous comparons les fonctionnalités documentées sur les pages publiques ; les entrées manquantes signifient que nous n’avons pas pu confirmer leur existence.',
  },
  testimonials: {
  ...
  achievements: {
    ...
    body: 'Tickra débloque un badge pour chaque jalon — première bougie, streak trois jours, niveau cinq, piste complète. Rien de plus, rien de moins.',
    unlocked: 'Débloqué',
    locked: 'Verrouillé',
    progress: '{n} sur {total} débloqués',
  },
  leaderboard: {
    eyebrow: 'Classement',
    title: 'Top 100, par XP.',
    body: 'Classement public des apprenants les plus engagés. Mis à jour en continu.',
    rank: 'Rang',
    name: 'Nom',
    xp: 'XP',
    streakBest: 'Record streak',
    level: 'Niveau',
    empty: 'Aucun apprenant encore — soyez le premier.',
  },
  search: {
    eyebrow: 'Recherche',
